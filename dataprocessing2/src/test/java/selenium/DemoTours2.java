...
public class DemoTours2 {
    ...
    public void signon() {
        ...
        signonLink.click();
        Assert.assertTrue(driver.findElement(By.xpath("//img[@src='images/mast_signon.gif']")).isDisplayed());
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//img[@src='images/mast_flightfinder.gif'")).isDisplayed());
    ...
    public void test() {
        ...
        DemoTours2.username = username;
        DemoTours2.password = password;
    }
